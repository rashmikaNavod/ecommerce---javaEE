<%@ page import="lk.ijse.demo.controller.product.FlashSaleItemSave" %>
<%@ page import="java.util.List" %>
<%@ page import="lk.ijse.demo.dto.FlashSaleProduct" %>
...
<nav>
  <div class="container d-flex align-items-center justify-content-between">
    ...
    <div class="d-flex align-items-center gap-1">
      <a class="nav-btn" data-bs-toggle="modal" data-bs-target="#logInModal"  href="" >LOGIN</a>
      <a class="nav-btn"  href="">SIGN&nbspUP</a>
    </div>
...
<%--        just for you--%>
  <div class="just-for-you container" >
    <h2>Just For You</h2>
    <div class="just-for-you-slider row">

      <div class="just-for-you-item col-lg-2">
        <div class="img-box">
        <img class="" src="" alt="">
        </div>
        <h6></h6>
        <h4 class="main-price">$.<sup></sup></h4>
        <div></div>
        ...
        <div class="modal-body">
          ...
          <form>
            <div class="form-group">
              <label for="mobile">Email or mobile phone number:</label>
